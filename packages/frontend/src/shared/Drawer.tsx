...
>(({ className, children, ...props }, ref) => (
    <DrawerPortal>
        ...
        <DrawerPrimitive.Content
            ref={ref}
            className={clsx(
                "fixed inset-x-0 bottom-0 z-50 mx-auto mt-24 flex h-auto max-w-lg flex-col rounded-t-2xl bg-neutral-600 px-4 pb-8",
                className,
            )}
            {...props}
        >
...
>(({ className, ...props }, ref) => (
    <DrawerPrimitive.Title
        ref={ref}
        className={clsx("pt-4 text-heading-3 text-neutral-300", className)}
        {...props}
    />
));
